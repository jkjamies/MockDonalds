package com.jkjamies.sampleplatter.konsist.layers
    ...
    Given("api module exports") {
        Then("all Screen files in api navigation should import circuit.runtime") {
            ...
            val screenContracts = setOf(
                ...
                "com.jkjamies.sampleplatter.core.circuit.TabScreen",
                "com.jkjamies.sampleplatter.core.circuit.FlowScreen",
                "com.jkjamies.sampleplatter.core.circuit.ProtectedScreen",
            )

            // Named exactly, not by prefix: `com.jkjamies.sampleplatter.core.circuit.*` also holds
