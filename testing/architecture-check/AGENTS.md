...
| kiosk/ | KioskBoundaryTest | Compile-time separation between consumer and kiosk surfaces. composeApp must not import features/kiosk/*; kiosk host (kioskApp + kioskComposeApp) and features/kiosk/* must not import any consumer-only feature; kiosk surfaces must not reference any TabScreen implementation. See [`../../specs/kiosk-app.md`](../../specs/kiosk-app.md) and [`../../features/kiosk/AGENTS.md`](../../features/kiosk/AGENTS.md). |
