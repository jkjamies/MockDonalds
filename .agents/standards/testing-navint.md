...
- **Location**: `testing/mobile/navint-tests/src/androidDeviceTest/kotlin/`
...
|---|---|---|---|---|
| Location | `impl/*/commonTest/` | `impl/presentation/androidDeviceTest/` | `testing/mobile/navint-tests/` or `iosAppTests/NavInt/` | `testing/mobile/e2e-tests/` |
