...
class BuildConfigRegistryProcessor(
    ...
    private fun writeFile(rows: List<RegistryRow>, containingFile: KSClassDeclaration) {
        ...
        val functionBuilder = FunSpec.builder("generatedFields")
        ...
        containingFile.containingFile?.let { functionBuilder.addOriginatingKSFile(it) }

        FileSpec.builder(PACKAGE, GENERATED_FILE_NAME)
    ...
    private companion object {
        const val PACKAGE = "com.jkjamies.sampleplatter.core.buildconfig"
