...
- Sibling api deps: `:features:mobile:more:api:navigation` (to implement `MoreTabExtension`)
...
- E2E: `DebugMenuTestTags` referenced from a journey in `testing/mobile/e2e-tests/` so the arch suite keeps the tags live
