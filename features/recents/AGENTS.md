...
| GetRecentsContent | api/domain -> impl/domain | Streaming use case via StrataSubjectInteractor<Unit, RecentsContent> |
...
- Core deps: core:strata, core:circuit, core:theme
