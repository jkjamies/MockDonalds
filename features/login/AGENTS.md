...
| GetLoginContent | api/domain -> impl/domain | Streaming use case via StrataSubjectInteractor<Unit, LoginContent> |
...
- AppleSignInClicked and GoogleSignInClicked are currently no-op strata placeholders.
