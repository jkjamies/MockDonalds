...
/**
 * [StrataDispatchers] for tests: all three route to one [StandardTestDispatcher].
 *
 ...
 *
 * This matters for any code doing `withContext(dispatchers.io) { … }`, the documented Strata
