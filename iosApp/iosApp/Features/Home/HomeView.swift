            ...
            VStack(alignment: .leading, spacing: 48) {
                    ...
                    Color.clear
                        ...
                        .overlay(alignment: .bottomLeading) {
                            VStack(alignment: .leading, spacing: 16) {
                                ...
                                Button(action: { state.eventSink(HomeEvent.HeroCtaClicked()) }) {
                                    Text(hero.ctaText)
                                        .font(.caption)
                                        .fontWeight(.bold)
                ...
                if !state.recentCravings.isEmpty {
                    VStack(alignment: .leading, spacing: 24) {
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 24) {
                                ForEach(Array(state.recentCravings.enumerated()), id: \.offset) { _, craving in
                                    CravingCard(
                                        title: craving.title,
                ...
                if !state.exploreItems.isEmpty {
                    VStack(alignment: .leading, spacing: 24) {
                        ...
                        ForEach(Array(state.exploreItems.dropFirst(2).enumerated()), id: \.offset) { _, item in
                            HStack(spacing: 16) {
                                Circle()
